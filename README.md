# Bricks.Storage.Relation.Mapper

Пакет реализует механизм объектно-реляционного преобразования данных для 
взаимодействий с используемой РСУБД с использованием PDO адаптера.
...
[исходные коды]: https://github.com/Bashka/bricks_storage_relation_mapper/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_storage_relation_mapper/issues
